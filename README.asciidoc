...
== Fork Note
This is a fork of https://github.com/IntershopCommunicationsAG/jaxb-gradle-plugin . It's used to publish early releases of https://github.com/IntershopCommunicationsAG/jaxb-gradle-plugin/issues/70 and https://github.com/IntershopCommunicationsAG/jaxb-gradle-plugin/issues/71 to support gradle caching.
